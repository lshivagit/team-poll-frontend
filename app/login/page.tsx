...
function LoginContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Show "Waking up..." after 3 seconds
            ...
            <div className="relative">
              ...
              >
                {showPassword ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                )}
              </button>
            </div>
          </div>
            ...
            {loading ? (
              <span className="flex flex-col items-center justify-center gap-1">
                <span className="flex items-center gap-2">
                  ...
                  {isSlow ? "Server is waking up..." : "Authenticating..."}
                </span>
                {isSlow && (
                  <span style={{ fontSize: '0.7rem', opacity: 0.8, fontWeight: 500 }}>
                    Initializing Render backend (Free Tier)
                  </span>
                )}
              </span>
            ) : "Sign In to Account"}
