...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Auto login
      const data = await api.post<{ access_token: string; user_id: string }>("/login", { email, password })
      ...
      <div className="w-full max-w-md relative z-10" style={{
        ...
        <div className="flex justify-center mb-8">
           <div style={{
             ...
             <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
           </div>
        </div>

        <h1 style={{ fontSize: '2.25rem', fontWeight: 900, color: '#0f172a', textAlign: 'center', marginBottom: '8px', letterSpacing: '-0.04em' }}>Get Started</h1>
        <p style={{ fontSize: '1.05rem', color: '#64748b', textAlign: 'center', marginBottom: '40px', fontWeight: 500 }}>Create an account to start polling your team</p>
        ...
        <p style={{ textAlign: 'center', marginTop: '32px', fontSize: '0.925rem', color: '#64748b', fontWeight: 600 }}>
          ...
          <Link href="/login" style={{ color: '#4f46e5', fontWeight: 800, textDecoration: 'none' }} className="hover:underline">
            Sign In
          </Link>
        </p>
      </div>
